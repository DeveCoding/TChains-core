...
Code in libraries is the most important part of **tchains-core** project and it is maintained by the Bitshares Core Team and contributors.
# Available Libraries
...
[plugins](plugins) | Plugins | Collection of singleton designed modules used for extending the tchains-core.  | Active 
